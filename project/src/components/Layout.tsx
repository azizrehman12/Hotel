...
import { Menu, X, Home, Bed, MapPin, Phone, Image, User, Star, Wifi } from 'lucide-react';
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900">Backpackers Hostel</span>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4">
                Providing safe, affordable, and comfortable accommodation for students across Pakistan.
              </p>
